!(function () {
  var eventMethod = window.addEventListener
    ...
    config = {
      siteUrl: "https://zestpayment.com/",
      zestpayApiUrl: "https://api.dev.gateway.zestpayment.com/",
      newCheckoutUrl: "http://localhost:4200/",
    };
  class Inline {
    constructor(t) {
      (this.iframe = null),
    ...
    setTransaction(t) {
      this.defaults && this.resetNewCheckout(),
        ...
        this.isEmbed
          ? (this.removeNewCheckout(), this.setupEmbed())
          : this.updateIframe();
    }
    setForm(t) {
    ...
    loadButtonCSS() {
      var t = this;
      new cssLoad(config.siteUrl + "public/css/button.min.css").done(
        function () {
          t.loadedButtonCSS = !0;
        }
      );
    ...
    createButton() {
      ...
      e.defaults.customButton
        ? (t = document.getElementById(e.defaults.customButton)).setAttribute(
            "data-zestpay",
            e.defaults.id
          )
        : (((t = document.createElement("button")).innerHTML =
            "<span class='zestpay-top-blue'>Pay Securely with Zest</span><span class='zestpay-body-image'> </span>"),
          t.setAttribute("class", "zestpay-trigger-btn"),
          t.setAttribute("data-zestpay", e.defaults.id),
    ...
    setupEmbed() {
      ...
      (t.innerHTML = ""),
        ...
        (t.className = "zestpay-embed-container"),
    ...
    getTransactionParameters() {
      ...
      return (
        ...
        // uncomment this if a string format for metadata is needed;
        // t.metadata &&
        // "string" != typeof t.metadata &&
        // (t.metadata = JSON.stringify(t.metadata)),
        t.split &&
          "string" != typeof t.split &&
          0 < Object.keys(t.split).length &&
          (t.split = JSON.stringify(t.split)),
        void 0 !== t.card &&
          -1 < ["false", !1].indexOf(t.card) &&
          ((t.channels = ["bank"]), delete t.card),
        void 0 !== t.bank &&
          -1 < ["false", !1].indexOf(t.bank) &&
          ((t.channels = ["card"]), delete t.bank),
        t
      );
    }
    getOldCheckoutURL() {
    ...
    updateIframe() {
      ...
      this.iframe.contentWindow.postMessage(
        { type: "inline:url", path: e, params: t },
        "*"
      );
    }
    listenForEvents() {
      ...
      eventer(
        ...
        function (t) {
          e.isEmbed
            ? e.handleOldCheckoutEvents(t)
            : e.checkoutRemoved || e.handleNewCheckoutEvents(t);
        },
        !1
      );
    }
    handleOldCheckoutEvents(t) {
      var e = this,
        n = t.data || t.message;
      if (n && ("string" == typeof n || n instanceof String)) {
        var r = parseResponse(n, e.defaults),
          i = r.isThisIframe && "ZestpayClose" === r.action,
          a = "close" === r.action;
        if (i || a) {
          var o = r.data;
          e.isEmbed || e.closeOldCheckout(),
            o
              ? e.handleSuccess(JSON.parse(o))
              : e.defaults.onClose && e.callCloseCallback();
        }
        "ZestpayTLSClose" == r.action &&
          (e.defaults.tlsFallback.call(this),
          e.isEmbed || e.closeOldCheckout());
      }
    }
      ...
      eventer(
        ...
        function (t) {
          ...
          if (e && ("string" == typeof e || e instanceof String)) {
            ...
            if (!n.isThisIframe || "ZestpayResize" != n.action) return;
            document.getElementById(r.defaults.container).style.height =
              Math.max(Number(n.data), 250) + "px";
          }
        },
        !1
      );
    ...
    openOldCheckout() {
      ...
      if (!this.iframeOpen) {
        var t = function () {
          ...
          t.contentWindow.postMessage("ZestpayOpen " + e.defaults.id, "*"),
            e.isEmbed ||
    ...
    setupNewPopup() {
      ...
      t.setAttribute("frameBorder", "0"),
        ...
        (t.id = randomId()),
        (t.name = "zestpay-checkout-background-" + t.id),
        (t.style.cssText =
    ...
    removeLoader() {
      (this.iframe.style.visibility = "visible"),
        (this.background.contentWindow.document.getElementById(
          "app-loader"
        ).style.display = "none");
    }
    handleNewCheckoutEvents(t) {
      if (
        t.origin + "/" === config.newCheckoutUrl &&
        this.iframe.contentWindow == t.source
      ) {
        var e = t.data || t.message;
        if (
          ("loaded:checkout" === e &&
            ((this.checkoutLoaded = !0), this.defaults && this.updateIframe()),
        ...
        try {
          ...
          n &&
            "success" === n.status &&
            (this.closeNewCheckout(!0), this.handleSuccess(n));
        } catch (t) {}
      }
    }
    closeNewCheckout(t) {
      ...
      if (this.defaults.callback || this.form)
        return this.form
          ? (((e = document.createElement("input")).type = "hidden"),
            ...
            ((e = document.createElement("input")).type = "hidden"),
            (e.value = t.reference),
            (e.name = "zestpay-trxref"),
            this.form.appendChild(e),
            void this.form.submit())
          : void (
              this.defaults.callback && this.defaults.callback.call(this, t)
            );
    }
    callCloseCallback() {
  ...
  var ZestPayPop = {
      ...
      setup: function (t, e) {
        var n = "zestpay" + randomId(),
          r = {
            ...
            transaction_charge:
              t.transaction_charge || t.transactionCharge || "",
            bearer: t.bearer || "",
            metadata: t.metadata || {},
            ...
            paymentLinkReference: t.paymentLinkReference || "",
          };
        if (isValid(r)) {
          if (
            (this.isInitialized ? ca.setTransaction(r) : this.initialize(r), !e)
          )
            return ca;
    ...
    ca;
  (window.ZestPayPop = ZestPayPop),
    (window.onload = function () {
      ZestPayPop.isInitialized || ZestPayPop.initialize();
    });
  var sourceScript =
  ...
  function isValid(t) {
    if ((validateInputTypes(t), null == t.key))
  ...
  function checkForParentForm(t) {
    ...
    throw new Error(
      "Please put your Zest Inline javascript file inside of a form element"
    );
  }
    ...
    ZestPayPop.setup(
      {
        ...
        paymentMode: sourceScript.getAttribute("data-payment-mode"),
        paymentLinkReference: sourceScript.getAttribute(
          "data-payment-link-reference"
        ),
      },
      sourceScript
    );
  ...
  (function (t) {
    ...
    if (!t.fetch) {
      ...
      g.call(w.prototype), g.call(_.prototype), (l = [301, 302, 303, 307, 308]);
      (t.Headers = f),
        (t.Request = w),
        (t.Response = _),
          ...
          return new Promise(function (r, t) {
            ...
            (a.onload = function () {
              ...
              "include" === e.credentials
                ? (a.withCredentials = !0)
                : "omit" === e.credentials && (a.withCredentials = !1),
  ...
  (function (t, e) {
    ...
    class a {
      ...
      static _unhandledRejectionFn(t) {
        void 0 !== console &&
          console &&
